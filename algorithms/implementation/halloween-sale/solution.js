...
function howManyGames(p, d, m, s) { // Return the number of games you can buy
    var currentPrice = p; var gamesPurchased = 0;

    while (s > 0 && currentPrice > m) {
        s -= currentPrice;
